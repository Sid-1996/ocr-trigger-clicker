...
> 💡 點在文字上的點擊會自動變成「等文字出現再點擊」，畫面上沒有文字的點擊會嘗試用圖示比對，都沒有的會變成固定等待後點擊。座標一律存為視窗比例，視窗大小／解析度變化也不怕。
...
按工具列的「**匯出任務**」→ 存成 JSON → 貼到 [任務檔案分享討論區](https://github.com/Sid-1996/ocr-trigger-clicker/discussions/categories/%E4%BB%BB%E5%8B%99%E6%AA%94%E6%A1%88%E5%88%86%E4%BA%AB)。別人下載後「匯入任務」一鍵載入，座標自動適應解析度。
